...
function OnvifServiceMedia(params) {
	...
	// provide sslCertificatePath to mOnvifSoap
	if('sslCertificatePath' in params) {
		if(err_msg = mOnvifSoap.isInvalidValue(params['sslCertificatePath'], 'string', true)) {
			throw new Error('The "pass" property was invalid: ' + err_msg);
		} else {
			mOnvifSoap.setSslCertificatePath(params['sslCertificatePath'])
		}
	}
